# MMM-Angriffsskript (Fernkampf) für Midgard

Aktuelle Version: **1.7 vom 2021-03-27,** erfordert MMM 1.16.0+, ist im Midgard-Spiel (``#RangeAttack``) und im TEST-Spiel (``#mmmRangedAttack``) installiert.
